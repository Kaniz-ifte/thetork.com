...
class ClientController extends Controller
{
    ...
    {
         $this->middleware('permission:client-view|client-create|client-update|client-delete', ['only' => ['index']]);
         $this->middleware('permission:client-create', ['only' => ['create','store']]);
         $this->middleware('permission:client-update', ['only' => ['edit','update']]);
         $this->middleware('permission:client-delete', ['only' => ['destroy']]);
         $this->model='App\Client';
         $this->key_word='Client';
         $this->key_word_plural='Clients';
         $this->route_index='admin.clients.index';
         $this->route_create='admin.clients.create';
         $this->route_edit='admin.clients.edit';
         $this->route_update='admin.clients.update';
         $this->route_destroy='admin.clients.destroy';
         $this->route_store='admin.clients.store';
         ...
         $this->form_inputs=[
             ...
             [
                  "title"=> 'Banner:',
                  "id"=> 'image_1',
                  "sample_image"=> 'media/sample/client.jpg',
