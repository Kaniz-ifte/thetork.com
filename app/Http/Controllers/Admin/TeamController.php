...
class TeamController extends Controller
{
    ...
    {
         $this->middleware('permission:team-view|team-create|team-update|team-delete', ['only' => ['index']]);
         ...
         $this->model='App\Team';
         $this->key_word='Team';
         $this->key_word_plural='Teams';
         $this->route_index='admin.teams.index';
         $this->route_create='admin.teams.create';
         $this->route_edit='admin.teams.edit';
         $this->route_update='admin.teams.update';
         $this->route_destroy='admin.teams.destroy';
         $this->route_store='admin.teams.store';
         ...
         $this->form_inputs=[
             ...
             [
                  "title"=> 'Avatar:',
                  "id"=> 'image_1',
                  "sample_image"=> 'media/sample/team.jpg',
